...
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} Value
 ,\,\@s{21.68}}%
\@y{\@s{0}%
 the set of values to be proposed and chosen from
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} Acceptor
 ,\,\@s{8.2}}%
\@y{\@s{0}%
 the set acceptors
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} Quorum\@s{16.17}}%
\@y{\@s{0}%
 the quorum system on acceptors
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} None \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Value}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Ballot \.{\defeq}\@s{4.1}
 Nat}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} CASOperation \.{\defeq} [
 cmpVal \.{:} Value \.{\cup} \{ None \} ,\, swapVal \.{:} Value ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Message \.{\defeq}}%
\@y{\@s{0}%
 the set of all possible messages that can be sent in the algorithm
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{28.7} [ type\@s{2.83}
 \.{:} \{\@w{1a} \} ,\, bal\@s{1.93} \.{:} Ballot ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38} [
 type\@s{2.83} \.{:} \{\@w{1b} \} ,\, acc \.{:} Acceptor ,\, bal \.{:} Ballot
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{31.47} mbal \.{:} Ballot
 \.{\cup} \{ \.{-} 1 \} ,\, mval \.{:} Value \.{\cup} \{ None \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38} [
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} {\VARIABLES}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} maxBal
 ,\,\@s{7.43}}%
\@y{}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} maxVBal ,\,}%
\@y{}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} maxVVal
 ,\,\@s{0.37}}%
\@y{}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} msgs ,\,\@s{19.32}}%
\@y{\@s{0}%
 the set of all messages that have been sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} ops\@s{32.07}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} vars \.{\defeq} {\langle}
 maxBal ,\, maxVBal ,\, maxVVal ,\, msgs ,\, ops {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 maxBal\@s{7.43} \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-}
 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{56.14} \.{\land} maxVBal
 ...
 \.{\subseteq} Message}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{56.14} \.{\land} ops
 \.{\in} [ Ballot \.{\rightarrow} CASOperation ]}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} Init \.{\defeq} \.{\land}
 maxBal\@s{7.43} \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{35.70} \.{\land} maxVBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{35.70} \.{\land}
 maxVVal\@s{0.37} \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{35.70}}%
\@y{\@s{0}%
 \ensuremath{ops} remains unchanged; we utilize \ensuremath{TLC} to explore
 all possible \ensuremath{CAS} operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{35.70} \.{\land} ops
 \.{\in} [ Ballot \.{\rightarrow} CASOperation ]}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} Phase1a ( b ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land}\@s{9.81}
 Send ( [ type \.{\mapsto}\@w{1a} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land}\@s{9.81}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} Phase1b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{8.2} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{26.53} \.{\land} m . type
 \.{=}\@w{1a}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{26.53} \.{\land} m . bal
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{26.53} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{26.53} \.{\land} Send ( [
 type\@s{2.83} \.{\mapsto}\@w{1b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m
 . bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{66.29} mbal \.{\mapsto}
 maxVBal [ a ] ,\, mval \.{\mapsto} maxVVal [ a ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{8.2} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}} Phase2a ( b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m . type \.{=}\@w{2a} \.{\land} m . bal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{26.53} \.{\LET} Q1b
 \.{\defeq} \{ m \.{\in} msgs\@s{6.20} \.{:} \.{\land} m . type \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{148.25} \.{\land} m .
 acc \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{148.25} \.{\land} m .
 bal\@s{1.57} \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{51.03} Q1bv \.{\defeq}
 \{ m \.{\in} Q1b \.{:} m . mbal \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{26.53} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{51.03} \.{\land}
 \.{\lor} \.{\land} Q1bv \.{=} \{ \}\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{CAS(None,\, v)} as an initialization operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{73.25} \.{\land} ops [ b
 ] . cmpVal \.{=} None\@s{4.1}}%
\@y{\@s{0}%
 added for \ensuremath{CASPaxos
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{62.14} \.{\lor} \E\, m
 \.{\in} Q1bv \.{:}\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{81.45} \.{\land} ops [ b
 ] . cmpVal \.{=} v\@s{4.1}}%
\@y{\@s{0}%
 added for \ensuremath{CASPaxos
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{8.2} \.{\land} Send ( [
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}} Phase2b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{8.2} \E\, m \.{\in} msgs
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{19.52} \.{\land} m .
 type \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{19.52} \.{\land} m . bal
 \.{\geq} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{19.52} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{19.52} \.{\land} maxVBal
 \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{19.52} \.{\land} maxVVal
 \.{'}\@s{0.37} \.{=} [ maxVVal {\EXCEPT} {\bang} [ a ]\@s{0.37} \.{=} m .
 val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{19.52} \.{\land} Send (
 [ type \.{\mapsto}\@w{2b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m . bal
 ,\, val \.{\mapsto} m . val ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{19.52} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}} Respond ( b ) \.{\defeq}
 {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Phase1a ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{112.86} \.{\lor} \E\, v
 \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{112.86} \.{\lor} Respond
 ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} Phase1b ( a ) \.{\lor} Phase2b ( a )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}}\bottombar\@xx{}%
\end{document}
