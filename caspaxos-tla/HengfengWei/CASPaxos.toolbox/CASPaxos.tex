...
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} Value
 ,\,\@s{21.68}}%
\@y{\@s{0}%
 the set of values to be proposed and chosen from
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} Acceptor
 ,\,\@s{8.2}}%
\@y{\@s{0}%
 the set acceptors
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} Quorum\@s{16.17}}%
\@y{\@s{0}%
 the quorum system on acceptors
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} None \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Value}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\ASSUME}\@s{4.1} \.{\land}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{42.34} \.{\land} \A\, Q1
 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Ballot \.{\defeq}\@s{4.1}
 Nat}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{maxBal[a]}: the last ballot the acceptor \ensuremath{a \.{\in}
 Acceptor} has voted for
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} maxBal ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} maxVBal ,\, maxVVal
 ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} msgs ,\,\@s{12.29}}%
\@y{\@s{0}%
 the set of all messages that have been sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} ops\@s{25.05}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 maxBal\@s{7.43} \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-}
 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{56.14} \.{\land} maxVBal
 ...
 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{56.14} \.{\land} msgs
 \.{\subseteq} Message}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{56.14} \.{\land} ops
...
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Init \.{\defeq} \.{\land}
 maxBal\@s{7.43} \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{35.70} \.{\land} maxVBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{35.70} \.{\land}
 maxVVal\@s{0.37} \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{35.70}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{35.70} \.{\land} ops
 \.{\in} [ Ballot \.{\rightarrow} CASOperation ]}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} Phase1b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{8.2} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{26.53} \.{\land} m . type
 \.{=}\@w{1a}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{26.53} \.{\land} m . bal
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{26.53} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{26.53} \.{\land} Send ( [
 type\@s{2.83} \.{\mapsto}\@w{1b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m
 . bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{66.29} mbal \.{\mapsto}
 maxVBal [ a ] ,\, mval \.{\mapsto} maxVVal [ a ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{8.2} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}} Phase2a ( b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m . type \.{=}\@w{2a} \.{\land} m . bal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{26.53} \.{\LET} Q1b
 \.{\defeq} \{ m \.{\in} msgs\@s{6.20} \.{:} \.{\land} m . type \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{148.25} \.{\land} m .
 acc \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{148.25} \.{\land} m .
 bal\@s{1.57} \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{51.03} Q1bv \.{\defeq}
 \{ m \.{\in} Q1b \.{:} m . mbal \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{26.53} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{51.03} \.{\land}
 \.{\lor} \.{\land} Q1bv \.{=} \{ \}\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{73.25} \.{\land} ops [ b
 ] . cmpVal \.{=} None\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\langle}\.{+}{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{62.14} \.{\lor} \E\, m
 \.{\in} Q1bv \.{:}\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{81.45} \.{\land} m .
 mval \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{81.45} \.{\land} \A\, mm
 \.{\in} Q1bv \.{:} m . mbal \.{\geq} mm . mbal}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{81.45} \.{\land} ops [ b
 ] . cmpVal \.{=} v\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\langle}\.{+}{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{8.2} \.{\land} Send ( [
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVVal ,\, ops {\rangle}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} Phase2b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{8.2} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{26.53} \.{\land} m .
 type \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{26.53} \.{\land} m . bal
 \.{\geq} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{26.53} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{26.53} \.{\land} maxVBal
 \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{26.53} \.{\land} maxVVal
 \.{'}\@s{0.37} \.{=} [ maxVVal {\EXCEPT} {\bang} [ a ]\@s{0.37} \.{=} m .
 val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{26.53} \.{\land} Send (
 [ type \.{\mapsto}\@w{2b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m . bal
 ,\, val \.{\mapsto} m . val ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{8.2} \.{\land}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}} Respond ( b ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m . type \.{=}\@w{response} \.{\land} m .
 bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{26.53} \.{\LET} Q2b
 \.{\defeq} \{ m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{2b}}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{142.04} \.{\land} m .
 acc \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{142.04} \.{\land} m .
 bal\@s{1.57} \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{26.53} \.{\IN} \A\, a
 \.{\in} Q \.{:} \E\, m \.{\in} Q2b \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{8.2} \.{\land} Send ( [
 type \.{\mapsto}\@w{response} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVVal ,\, ops {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Phase1a ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{112.86} \.{\lor} \E\, v
 \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{112.86} \.{\lor} Respond
 ( b )}%
\@y{\@s{0}%
 \ensuremath{{\langle}\.{+}{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} \.{\lor} Phase1b ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{124.24} \.{\lor} Phase2b
 ( a )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}} Spec\@s{1.46} \.{\defeq}
