...
\setboolean{shading}{true}
 ...
 {\MODULE} CASConsensus}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{CASConsensus} is an operational semantics (or a reference model)
 of linearizable \ensuremath{CAS} registers.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{TODO}: how to model ``linearizable \ensuremath{CAS}
 registers''\.{?}
 how to distinguish it from ``sequentially consistent \ensuremath{CAS}
 registers''\.{?}
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Refs (\ensuremath{TODO}: \ensuremath{Google} for other references on
 operational semantics):
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{T}{0}{2.5}{%
-}%
``Model Checking \ensuremath{Linearizability} via Refinement''
 at https:\ensuremath{\.{\slsl}www.microsoft.com}/en-us/research/wp-content/uploads/2016/02/\ensuremath{linearizability.pdf
}%
\end{cpar}%
\begin{cpar}{1}{T}{T}{0}{2.5}{%
\ensuremath{\.{-}}}%
 ``\ensuremath{MonkeyDB}: Effectively Testing Correctness under Weak Isolation
 Levels''
 at https:\ensuremath{\.{\slsl}www.microsoft.com}/en-us/research/uploads/prod/2021/09/\ensuremath{main.pdf
}%
\end{cpar}%
\begin{cpar}{1}{T}{T}{0}{2.5}{%
\ensuremath{\.{-}}}%
 ``Using Lightweight Formal Methods to Validate a Key-Value Storage Node in
 \ensuremath{Amazon} \ensuremath{S3}''
 at https:\ensuremath{\.{\slsl}assets.amazon.science}/07/\ensuremath{6c}/\ensuremath{81bfc2c243249a8b8b65cc2135e4}/using-lightweight-formal-methods-to-validate-a-key-value-storage-node-in-amazon-\ensuremath{s3.pdf
}%
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 27 10:08:20 \ensuremath{CST} 2022 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jul} 27
 00:22:59 \ensuremath{CST} 2022 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
