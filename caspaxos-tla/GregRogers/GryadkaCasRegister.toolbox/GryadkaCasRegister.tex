...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\CONSTANTS} Timestamps ,\,
 Values ,\, Acceptors ,\, Quorums}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} {\ASSUME} Timestamps
 \.{\subseteq} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} {\ASSUME} IsFiniteSet (
 Timestamps )}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} NoTS \.{\defeq} \.{-} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} {\ASSUME} NoTS \.{\notin}
 Timestamps}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\ASSUME} Quorums
 \.{\subseteq} {\SUBSET} Acceptors}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} {\ASSUME} \A\, q1 ,\, q2
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} InitVal \.{\defeq} {\CHOOSE}
 v \.{\in} Values \.{:} {\TRUE}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} {\VARIABLES} msgs ,\, ops
 ,\, acceptorTS ,\, acceptorValTS ,\, acceptorValue ,\, history}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} Messages \.{\defeq} [ type
 \.{:} \{\@w{prepare} \} ,\, acceptor\@s{1.61} \.{:} Acceptors ,\, ts \.{:}
 Timestamps ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{20.5} \.{\cup} [
 type\@s{28.24} \.{:} \{\@w{promise} \} ,\, acceptor \.{:} Acceptors ,\, ts
 \.{:} Timestamps ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{34.38} prevTS \.{:}
 Timestamps \.{\cup} \{ NoTS \} ,\, prevVal\@s{0.09} \.{:} Values ]}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{20.5} \.{\cup} [ type
 \.{:} \{\@w{accept} \} ,\, acceptor \.{:} Acceptors ,\, ts \.{:} Timestamps
 ,\, val \.{:} Values ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{20.5} \.{\cup} [ type
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Operations \.{\defeq} [
 oldVal \.{:} Values ,\, newVal \.{:} Values ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Events\@s{7.41} \.{\defeq} [
 type \.{:} \{\@w{invoke} ,\,\@w{response} \} ,\, ts \.{:} Timestamps ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 msgs \.{\subseteq} Messages}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{56.14} \.{\land} ops
 \.{\in} [ Timestamps \.{\rightarrow} Operations ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{56.14} \.{\land}
 acceptorTS \.{\in} [ Acceptors \.{\rightarrow} Timestamps \.{\cup} \{ NoTS
 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{56.14} \.{\land}
 acceptorValTS \.{\in} [ Acceptors \.{\rightarrow} Timestamps \.{\cup} \{
 NoTS \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{56.14} \.{\land}
 acceptorValue\@s{3.25} \.{\in} [ Acceptors \.{\rightarrow} Values ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{56.14} \.{\land} history
 \.{\in} Seq ( Events )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Init \.{\defeq} \.{\land}
 msgs \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{35.70} \.{\land} ops
 \.{\in} [ Timestamps \.{\rightarrow} Operations ]}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{35.70} \.{\land}
 acceptorTS \.{=} [ a \.{\in} Acceptors \.{\mapsto} NoTS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{35.70} \.{\land}
 acceptorValTS \.{=} [ a \.{\in} Acceptors \.{\mapsto} NoTS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{35.70} \.{\land}
 acceptorValue\@s{3.25} \.{=} [ a \.{\in} Acceptors \.{\mapsto} InitVal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{35.70} \.{\land} history
 \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} SelectMessages ( type ,\, ts
 ) \.{\defeq} \{ m \.{\in} msgs \.{:} m . type \.{=} type \.{\land} m . ts
 \.{=} ts \}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} PromisedValue ( ts )
 \.{\defeq} \.{\LET} promiseMsgs \.{\defeq} SelectMessages (\@w{promise} ,\,
 ts )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{100.08} \.{\IN} (
...
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Prepare ( ts ) \.{\defeq}
 \.{\land} SelectMessages (\@w{prepare} ,\, ts ) \.{=} \{ \}}%
\@y{\@s{0}%
 Each timestamp must be unique
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{68.75} \.{\land} msgs
 \.{'} \.{=} msgs \.{\cup} [ type \.{:} \{\@w{prepare} \} ,\, acceptor \.{:}
 Acceptors ,\, ts \.{:} \{ ts \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{68.75} \.{\land} history
...
\@pvspace{8.0pt}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{107.82} \.{\land} msgs
 \.{'} \.{=} msgs \.{\cup} [ type \.{:} \{\@w{accepted} \} ,\, acceptor \.{:}
 \{ a \} ,\, ts \.{:} \{ ts \} ,\, val \.{:} \{ v \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{107.82} \.{\land}
 {\UNCHANGED} {\langle} ops ,\, acceptorTS ,\, history {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} Accepted ( ts ) \.{\defeq}
 \.{\land} \{ m . acceptor \.{:} m \.{\in} SelectMessages (\@w{accepted} ,\,
 ts ) \} \.{\in} Quorums}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{73.26} \.{\land} \{ hpos
 \.{\in} {\DOMAIN} history \.{:} history [ hpos ] \.{=} [ type
 \.{\mapsto}\@w{response} ,\, ts \.{\mapsto} ts ] \} \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{73.26} \.{\land} history
 \.{'} \.{=} Append ( history ,\, [ type \.{\mapsto}\@w{response} ,\, ts
 \.{\mapsto} ts ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{73.26} \.{\land}
 {\UNCHANGED} {\langle} msgs ,\, ops ,\, acceptorTS ,\, acceptorValTS ,\,
 acceptorValue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, ts \.{\in} Timestamps \.{:} \.{\lor} Prepare ( ts )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{141.78} \.{\lor} Accept (
 ts )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{141.78} \.{\lor} Accepted
 ( ts )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{39.83} \.{\lor} \E\, m
 \.{\in} msgs \.{:} \.{\lor} m . type \.{=}\@w{prepare} \.{\land} RecvPrepare
 ( m . acceptor ,\, m . ts )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{110.55} \.{\lor} m . type
 \.{=}\@w{accept} \.{\land} RecvAccept ( m . acceptor ,\, m . ts ,\, m . val
 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ {\langle} msgs ,\, ops ,\, acceptorTS ,\,
 acceptorValTS ,\, acceptorValue ,\, history {\rangle}}}%
\@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} FiniteSeq ( S ) \.{\defeq}
 {\UNION} \{ [ 1 \.{\dotdot} n \.{\rightarrow} S ] \.{:} n \.{\in} 1
 \.{\dotdot} Cardinality ( S ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} SeqAsSet ( S ) \.{\defeq}
 \{ S [ i ] \.{:} i \.{\in} {\DOMAIN} S \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} HistoryIsLinearizable
 \.{\defeq} \E\, order \.{\in} \{ {\langle} {\rangle} \} \.{\cup} FiniteSeq (
 Timestamps ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land} \A\, H
 \.{\in} SeqAsSet ( history ) \.{:} H . type \.{=}\@w{response} \.{\implies}
 H . ts \.{\in} SeqAsSet ( order )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} \A\,
 H1\_i ,\, H2\_i \.{\in} {\DOMAIN} history \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{31.61} ( history [ H1\_i
 ] . type \.{=}\@w{response} \.{\land} history [ H2\_i ] . type
 \.{=}\@w{invoke} \.{\land} H1\_i \.{<} H2\_i ) \.{\implies}}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{47.79} (}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{64.19} history [ H2\_i ]
 . ts \.{\in} SeqAsSet ( order ) \.{\implies}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{80.59} \E\, i1 ,\, i2
 \.{\in} {\DOMAIN} order \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{91.92} \.{\land} order [
 i1 ] \.{=} history [ H1\_i ] . ts}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{91.92} \.{\land} order [
 i2 ] \.{=} history [ H2\_i ] . ts}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{91.92} \.{\land} i1
 \.{<} i2}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{47.79} )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \.{\land} \A\, i1
 ,\, i2 \.{\in} {\DOMAIN} order \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{31.61} i2 \.{=} i1 \.{+}
 1 \.{\implies} ops [ order [ i1 ] ] . newVal \.{=} ops [ order [ i2 ] ] .
 oldVal}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{16.4} \.{\land} order
 \.{\neq} {\langle} {\rangle} \.{\implies} InitVal \.{=} ops [ order [ 1 ] ]
 . oldVal}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} Inv \.{\defeq} \.{\land}
 TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{34.04} \.{\land}
 HistoryIsLinearizable}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}}\bottombar\@xx{}%
\end{document}
