...
\setboolean{shading}{true}
 ...
 {\MODULE} ScyllaPaxos}\moduleRightDash\@xx{}%
...
\@pvspace{8.0pt}%
 ...
 \{ None \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{190.65} version \.{:}
 Version ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{56.14} \.{\land} msgs
 \.{\subseteq} Message}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{56.14} \.{\land} balValue
 \.{\in} [ Ballot \.{\rightarrow} [ expVal \.{:} Value \.{\cup} \{ None \}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{165.65} setVal\@s{2.33}
 \.{:} Value \.{\cup} \{ None \} ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Init \.{\defeq} \.{\land}
 maxBal\@s{4.1} \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{35.70} \.{\land}
 maxAccBal \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{35.70} \.{\land}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{35.70} \.{\land} balValue
 \.{=} [ b \.{\in} Ballot \.{\mapsto} [ expVal \.{\mapsto} None ,\, setVal
 \.{\mapsto} None ] ]}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} CAS ( ev ,\, sv ,\, b )
 \.{\defeq}\@s{4.1} \.{\land} {\lnot} \E\, m \.{\in} msgs \.{:} m . type
 \.{=}\@w{Prepare} \.{\land} m . bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{89.66} \.{\land} Send ( [
 type \.{\mapsto}\@w{Prepare} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{89.66} \.{\land} balValue
 \.{'} \.{=} [ balValue {\EXCEPT} {\bang} [ b ] \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{156.50} [ expVal
 \.{\mapsto} ev ,\, setVal \.{\mapsto} sv ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{89.66} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{129.48} maxComVal ,\,
 dataResult {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}}%
\@y{\@s{0}%
 Promise \ensuremath{Message} add \ensuremath{ReadResult(value,\,version)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} Promise ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{8.2} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{26.53} \.{\land} m . type
 \.{=}\@w{Prepare}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{26.53} \.{\land} m . bal
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{26.53} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{26.53} \.{\land} Send ( [
 type \.{\mapsto}\@w{Promise} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m .
 bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{70.39} maxAccBal\@s{4.83}
 \.{\mapsto} maxAccBal [ a ] ,\, maxAccVal\@s{9.66} \.{\mapsto} maxAccVal [ a
 ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{70.39} maxComBal
 \.{\mapsto} maxComBal [ a ] ,\, maxComVal \.{\mapsto} maxComVal [ a ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{70.39} value \.{\mapsto}
 dataResult [ a ] . value ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{70.39} version
...
\@pvspace{16.0pt}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{102.25} preValue
 \.{\defeq} ( {\CHOOSE} m \.{\in} Qmset \.{:} m . maxAccBal \.{=} maxAccbal )
 . maxAccVal}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{102.25} QResult
 \.{\defeq} \{ m . value \.{:} m \.{\in} Qmset \}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{102.25} maxVersion
 \.{\defeq} Maximum ( \{ m . version \.{:} m \.{\in} Qmset \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{106.35} maxValue
 \.{\defeq} ( {\CHOOSE} m \.{\in} Qmset \.{:} m . version \.{=} maxVersion )
 . value}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{81.85} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Qmset \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{106.35} \.{\land} {\IF}
 maxAccbal \.{>} maxCombal}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{129.62} \.{\THEN} Send (
 [ type \.{\mapsto}\@w{Propose} ,\, bal \.{\mapsto} b ,\, val \.{\mapsto}
 preValue ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{129.62} \.{\ELSE} {\IF}
 MeetCondition ( balValue [ b ] . expVal ,\, maxValue )}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{173.09} \.{\THEN} Send (
 [ type \.{\mapsto}\@w{Propose} ,\, bal \.{\mapsto} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{230.28} val \.{\mapsto}
 balValue [ b ] . setVal ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{173.09} \.{\ELSE} Send (
 [ type \.{\mapsto}\@w{Terminate} ,\, bal \.{\mapsto} b ] )}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{106.35}}%
\@y{%
 \ensuremath{\.{\land} {\IF}} \ensuremath{{\lnot}Same(QResult) \.{\THEN}
 Send([type \.{\mapsto} \@w{Repair},\,
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{106.35}}%
\@y{\@s{75.0}%
 \ensuremath{value \.{\mapsto} maxValue},
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{106.35}}%
\@y{\@s{75.0}%
 \ensuremath{version \.{\mapsto} maxVersion}])
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{66.64} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,
 maxComVal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{144.33} dataResult ,\,
 balValue {\rangle}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}} Accept ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Propose}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{132.34} \.{\land} maxBal
 [ a ] \.{\leq} m . bal}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{132.34} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{132.34} \.{\land}
 maxAccBal \.{'} \.{=} [ maxAccBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{132.34} \.{\land}
 maxAccVal \.{'}\@s{0.37} \.{=} [ maxAccVal {\EXCEPT} {\bang} [ a ]\@s{0.37}
 \.{=} m . val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{132.34} \.{\land} Send (
 [ type \.{\mapsto}\@w{Accept} ,\, bal \.{\mapsto} m . bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{169.33} val \.{\mapsto}
 m . val ,\, acc \.{\mapsto} a ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{61.62} \.{\land}
 {\UNCHANGED} {\langle} maxComBal ,\, maxComVal ,\, dataResult ,\, balValue
 {\rangle}}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}} Learn ( b ) \.{\defeq}
 \.{\land} {\lnot} \E\, m \.{\in} msgs \.{:} m . type \.{=}\@w{Learn}
 \.{\land} m . bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{57.46} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{72.67} \.{\LET} QAmset
 \.{\defeq} \{ m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Accept}}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{205.33} \.{\land} m .
 acc\@s{3.76} \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{205.33} \.{\land} m .
 bal \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{72.67} \.{\IN} \.{\land}
 \A\, a \.{\in} Q \.{:} \E\, m \.{\in} QAmset \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{57.46} \.{\land} Send (
 [ type \.{\mapsto}\@w{Learn} ,\, bal \.{\mapsto} b ,\, val \.{\mapsto}
 balValue [ b ] . setVal ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{57.46} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{131.05} maxComVal ,\,
 dataResult ,\, balValue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}} Ack ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Learn}}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{120.46} \.{\land} maxBal
 [ a ] \.{\leq} m . bal}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{120.46} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{120.46} \.{\land}
 maxComBal \.{'} \.{=} [ maxComBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{120.46} \.{\land}
 maxComVal \.{'}\@s{0.37} \.{=} [ maxComVal {\EXCEPT} {\bang} [ a ]\@s{0.37}
 \.{=} m . val ]}%
\@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{120.46}}%
\@y{%
 \ensuremath{\.{\land} dataResult\.{'} \.{=}} [\ensuremath{dataResult}
 \ensuremath{{\EXCEPT} {\bang}[a]\.{=}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{132.76}}%
\@y{%
 [\ensuremath{value \.{\mapsto} m.val}, \ensuremath{version
 \.{\mapsto}(@.version\.{+}1)}]]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}\@s{120.46}
 \.{\land}\@s{1.18} Send ( [ type \.{\mapsto}\@w{Ack} ,\, bal \.{\mapsto} m .
 bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{158.64} val \.{\mapsto}
 m . val ,\, acc \.{\mapsto} a ] )}%
\@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{49.74}}%
\@y{%
 \ensuremath{\.{\land}{\UNCHANGED} {\langle}maxAccBal,\, maxAccVal,\,
 balValue{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{49.74} \.{\land}
 {\UNCHANGED} {\langle} maxAccBal ,\, maxAccVal ,\, dataResult ,\, balValue
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, ev ,\, sv \.{\in} Value ,\, b \.{\in} Ballot \.{:} CAS ( ev ,\, sv ,\,
 b )}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{39.83} \.{\lor} \E\,
 b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Propose ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{112.86} \.{\lor} Learn (
 b )}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} \.{\lor} Promise ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{124.24} \.{\lor} Accept
 ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{124.24} \.{\lor} Ack ( a
 )}%
\@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}}\@s{124.24}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor} Repair(a)
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 177\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Feb} 27
 11:17:43 \ensuremath{CST} 2022 by \ensuremath{LENOVO
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Feb} 27 08:57:09
 \ensuremath{CST} 2022 by \ensuremath{LENOVO
}%
\end{cpar}%
\end{lcom}%
\end{document}
