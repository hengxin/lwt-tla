...
\setboolean{shading}{true}
 ...
 {\MODULE} CassandraPaxos}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers ,\,
 Sequences ,\, FiniteSets}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} Maximum ( S ) \.{\defeq}}%
\begin{lcom}{8.2}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{8.2} {\IF} S \.{=} \{ \}
 \.{\THEN} \.{-} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{50.50} \.{\ELSE}
 {\CHOOSE} n \.{\in} S \.{:} \A\, m \.{\in} S \.{:} n \.{\geq} m}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Same ( S ) \.{\defeq}}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 If \ensuremath{S} is not empty, then this define \ensuremath{Same(S)} to be
 the
 if or not the element of \ensuremath{S} is same.
 It is designed for determine whether the results of \ensuremath{Read} are
 the same
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{8.2} \.{\land} S \.{\neq}
 \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{8.2} \.{\land}\@s{4.1}
 \E\, n \.{\in} S \.{:} \A\, m \.{\in} S \.{:} n \.{=} m}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} {\CONSTANTS} Value ,\,
 Acceptor ,\, Quorum ,\, Operator}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} {\ASSUME}\@s{4.1} \.{\land}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{42.34} \.{\land} \A\, Q1
 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Ballot \.{\defeq} Nat}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Version \.{\defeq} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} None \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Value}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} MeetCondition ( ev ,\, val )
 \.{\defeq} \.{\lor} val \.{=} None}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{121.28} \.{\lor}
 {\CASE}\@s{4.1} Operator \.{=}\@w{\ensuremath{>}} \.{\rightarrow}
 val\@s{7.77} \.{>}\@s{4.1} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 Operator \.{=}\@w{\ensuremath{<}} \.{\rightarrow} val\@s{7.77}
 \.{<}\@s{4.10} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 Operator \.{=}\@w{=} \.{\rightarrow} val\@s{7.77} \.{=}\@s{4.1} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 Operator \.{=}\@w{\ensuremath{>}=} \.{\rightarrow} val \.{\geq} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 Operator \.{=}\@w{\ensuremath{<}=} \.{\rightarrow} val \.{\leq} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 Operator \.{=}\@w{/=}\@s{2.77} \.{\rightarrow} val \.{\neq} ev}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{144.69} {\Box}\@s{10.30}
 {\OTHER} \.{\rightarrow} {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} Message \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{28.7} [ type \.{:}
 \{\@w{Prepare} \} ,\, bal\@s{3.18} \.{:} Ballot ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38} [
 type \.{:} \{\@w{Promise} \} ,\, acc \.{:} Acceptor ,\, bal\@s{21.65} \.{:}
 Ballot ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{31.47} maxAccBal\@s{4.83}
 \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxAccVal\@s{4.83} \.{:} Value
 \.{\cup} \{ None \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{31.47} maxComBal \.{:}
 Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxComVal \.{:} Value \.{\cup} \{ None \}
 ]}%
...
\@pvspace{8.0pt}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{56.14} \.{\land}
 maxAccBal\@s{4.83} \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{
 \.{-} 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{56.14} \.{\land}
 maxAccVal\@s{5.20} \.{\in} [ Acceptor \.{\rightarrow} Value \.{\cup} \{ None
 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{56.14} \.{\land}
 maxComBal \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \}
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{56.14} \.{\land}
 maxComVal\@s{0.37} \.{\in} [ Acceptor \.{\rightarrow} Value \.{\cup} \{ None
 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{56.14} \.{\land}
 dataResult \.{\in} [ Acceptor \.{\rightarrow} [ value \.{:} Value \.{\cup}
 \{ None \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{190.65} version \.{:}
 Version ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{56.14} \.{\land} msgs
 \.{\subseteq} Message}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{56.14} \.{\land} balValue
 \.{\in} [ Ballot \.{\rightarrow} [ expVal \.{:} Value \.{\cup} \{ None \}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{165.65} setVal\@s{2.33}
 \.{:} Value \.{\cup} \{ None \} ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} Init \.{\defeq} \.{\land}
 maxBal\@s{4.1} \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{35.70} \.{\land}
 maxAccBal \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{35.70} \.{\land}
 maxAccVal\@s{4.1} \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{35.70} \.{\land}
 maxComBal \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{35.70} \.{\land}
 maxComVal\@s{4.1} \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{35.70} \.{\land}
 dataResult\@s{11.51} \.{=} [ a \.{\in} Acceptor \.{\mapsto} [ value
 \.{\mapsto} None ,\, version\@s{4.1} \.{\mapsto} 0 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{35.70} \.{\land} balValue
 \.{=} [ b \.{\in} Ballot \.{\mapsto} [ expVal \.{\mapsto} None ,\, setVal
 \.{\mapsto} None ] ]}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} CAS ( ev ,\, sv ,\, b )
 \.{\defeq}\@s{4.1} \.{\land} {\lnot} \E\, m \.{\in} msgs \.{:} m . type
 \.{=}\@w{Prepare} \.{\land} m . bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{89.66} \.{\land} Send ( [
 type \.{\mapsto}\@w{Prepare} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{89.66} \.{\land} balValue
 \.{'} \.{=} [ balValue {\EXCEPT} {\bang} [ b ] \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{156.50} [ expVal
 \.{\mapsto} ev ,\, setVal \.{\mapsto} sv ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{89.66} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{129.48} maxComVal ,\,
 dataResult {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} Promise ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{8.2} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{26.53} \.{\land} m . type
 \.{=}\@w{Prepare}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{26.53} \.{\land} m . bal
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{26.53} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{26.53} \.{\land} Send ( [
 type \.{\mapsto}\@w{Promise} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m .
 bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{70.39} maxAccBal\@s{4.83}
 \.{\mapsto} maxAccBal [ a ] ,\, maxAccVal\@s{9.66} \.{\mapsto} maxAccVal [ a
 ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{70.39} maxComBal
 \.{\mapsto} maxComBal [ a ] ,\, maxComVal \.{\mapsto} maxComVal [ a ]}%
\@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{63.52} ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxAccBal ,\, maxAccVal ,\, maxComBal ,\, maxComVal
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{81.99} dataResult ,\,
 balValue {\rangle}}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} Propose ( b ) \.{\defeq}
 \.{\land} {\lnot} \E\, m \.{\in} msgs \.{:} m . type \.{=}\@w{Propose}
 \.{\land} m . bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{66.64} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{81.85} \.{\LET} Qmset
 \.{\defeq} \{ m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Promise}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{207.33} \.{\land} m .
 acc \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{207.33} \.{\land} m .
 bal\@s{1.57} \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{102.25}
 maxAccbal\@s{4.83} \.{\defeq} Maximum ( \{ m . maxAccBal\@s{4.83} \.{:} m
 \.{\in} Qmset \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{102.25} maxCombal
 \.{\defeq} Maximum ( \{ m . maxComBal \.{:} m \.{\in} Qmset \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{106.35} preValue
 \.{\defeq} ( {\CHOOSE} m \.{\in} Qmset \.{:} m . maxAccBal \.{=} maxAccbal )
 . maxAccVal}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{81.85} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Qmset \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{106.35} \.{\land} {\IF}
 maxAccbal \.{>} maxCombal\@s{4.1} \.{\THEN} Send ( [ type
 \.{\mapsto}\@w{Propose} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{301.73} bal \.{\mapsto}
 b ,\, val \.{\mapsto} preValue ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{244.54} \.{\ELSE} Send (
 [ type \.{\mapsto}\@w{Read} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{66.64} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,
 maxComVal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{144.33} dataResult ,\,
 balValue {\rangle}}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}} Read ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Read}}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{125.39} \.{\land} Send (
 [ type \.{\mapsto}\@w{Result} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m .
 bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{165.15} value
 \.{\mapsto} dataResult [ a ] . value ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{165.15} version
 \.{\mapsto} dataResult [ a ] . version ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{54.67} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,
 maxComVal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{136.46} dataResult ,\,
 balValue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}} Result ( b ) \.{\defeq}
 \.{\land} \E\, Q \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{70.67} \.{\LET} QRmset
 \.{\defeq} \{ m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Result}}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{203.19} \.{\land} m .
 acc \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{203.19} \.{\land} m .
 bal\@s{1.57} \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{91.07} QResult
 \.{\defeq} \{ m . value \.{:} m \.{\in} QRmset \}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{91.07} maxVersion
 \.{\defeq} Maximum ( \{ m . version \.{:} m \.{\in} QRmset \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{95.17} maxValue
 \.{\defeq} ( {\CHOOSE} m \.{\in} QRmset\@s{1.24} \.{:} m . version \.{=}
 maxVersion ) . value}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{70.67} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} QRmset \.{:} m . acc \.{=}
 a}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{95.17} \.{\land} {\IF}
 MeetCondition ( balValue [ b ] . expVal ,\, maxValue )}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{126.64} \.{\THEN} Send (
 [ type \.{\mapsto}\@w{Propose} ,\, bal \.{\mapsto} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{183.82} val \.{\mapsto}
 balValue [ b ] . setVal ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{126.64} \.{\ELSE} Send (
 [ type \.{\mapsto}\@w{Terminate} ,\, bal \.{\mapsto} b ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{103.37}}%
\@y{%
 \ensuremath{\.{\land} {\IF}} \ensuremath{{\lnot}Same(QResult) \.{\THEN}
 Send([type \.{\mapsto} \@w{Repair},\,
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{103.37}}%
\@y{\@s{75.0}%
 \ensuremath{value \.{\mapsto} maxValue},
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{103.37}}%
\@y{\@s{75.0}%
 \ensuremath{version \.{\mapsto} maxVersion}])
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{78.87} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,
 maxComVal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{152.46} dataResult ,\,
 balValue {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{Repair(a) \.{\defeq} \.{\land} \E\, m \.{\in} msgs}:
 \ensuremath{\.{\land} m.type\.{=}\@w{Repair}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{77.5}{50.0}{}%
 \ensuremath{\.{\land} dataResult\.{'} \.{=}} [\ensuremath{dataResult}
 \ensuremath{{\EXCEPT} {\bang}[a] \.{=}
} [\ensuremath{value \.{\mapsto} m.value},
 \ensuremath{version \.{\mapsto} m.version}]]
\end{cpar}%
\begin{cpar}{1}{T}{F}{32.5}{0}{}%
 \ensuremath{\.{\land} {\UNCHANGED}{\langle}maxBal,\, maxAccBal,\,
 maxAccVal,\, maxComBal,\, maxComVal,\,
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{35.0}{0}{}%
\ensuremath{msgs,\, balValue{\rangle}
}%
\end{cpar}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}} Accept ( a )\@s{6.23}
 \.{\defeq} \.{\land} \E\, m \.{\in} msgs \.{:} \.{\land} m . type
 \.{=}\@w{Propose}}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{138.57} \.{\land} maxBal
 [ a ] \.{=} m . bal}%
\@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{138.57}}%
\@y{%
 \ensuremath{\.{\land} maxBal[a] \.{\leq} m.bal
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{138.57}}%
\@y{%
 \ensuremath{\.{\land} maxBal\.{'} \.{=}} [\ensuremath{maxBal}
 \ensuremath{{\EXCEPT} {\bang}[a] \.{=} m.bal}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{138.57} \.{\land}
 maxAccBal \.{'} \.{=} [ maxAccBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{138.57} \.{\land}
 maxAccVal \.{'}\@s{0.37} \.{=} [ maxAccVal {\EXCEPT} {\bang} [ a ]\@s{0.37}
 \.{=} m . val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{138.57} \.{\land} Send (
 [ type \.{\mapsto}\@w{Accept} ,\, bal \.{\mapsto} m . bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{175.56} val \.{\mapsto}
 m . val ,\, acc \.{\mapsto} a ] )}%
\@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{67.85}}%
\@y{%
 \ensuremath{\.{\land} {\UNCHANGED}{\langle}maxComBal,\, maxComVal,\,
 dataResult,\, balValue{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{67.85} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxComBal ,\, maxComVal ,\, dataResult ,\,
 balValue {\rangle}}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}} Commit ( b ) \.{\defeq}
 \.{\land} {\lnot} \E\, m \.{\in} msgs \.{:} m . type \.{=}\@w{Commit}
 \.{\land} m . bal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{67.85} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{83.06} \.{\LET} QAmset
 \.{\defeq} \{ m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Accept}}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{215.72} \.{\land} m .
 acc\@s{3.76} \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{215.72} \.{\land} m .
 bal \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{83.06} \.{\IN} \.{\land}
 \A\, a \.{\in} Q \.{:} \E\, m \.{\in} QAmset \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{67.85} \.{\land} Send (
 [ type \.{\mapsto}\@w{Commit} ,\, bal \.{\mapsto} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{104.84} val \.{\mapsto}
 balValue [ b ] . setVal ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{67.85} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, maxComBal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}}\@s{141.44} maxComVal ,\,
 dataResult ,\, balValue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 177\hspace{1em}} Ack ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:} \.{\land} m . type \.{=}\@w{Commit}}%
\@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}}\@s{120.46}}%
\@y{%
 \ensuremath{\.{\land} maxBal[a] \.{\leq} m.bal
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}}\@s{120.46}}%
\@y{%
 \ensuremath{\.{\land} maxBal\.{'} \.{=}} [\ensuremath{maxBal}
 \ensuremath{{\EXCEPT} {\bang}[a] \.{=} m.bal}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 180\hspace{1em}}\@s{120.46} \.{\land} maxBal
 [ a ] \.{=} m . bal}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}}\@s{120.46} \.{\land}
 maxComBal \.{'} \.{=} [ maxComBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 182\hspace{1em}}\@s{120.46} \.{\land}
 maxComVal \.{'}\@s{0.37} \.{=} [ maxComVal {\EXCEPT} {\bang} [ a ]\@s{0.37}
 \.{=} m . val ]}%
\@x{\makebox[0pt][r]{\scriptsize 183\hspace{1em}}\@s{120.46}}%
\@y{%
 \ensuremath{\.{\land} dataResult\.{'} \.{=}} [\ensuremath{dataResult}
 \ensuremath{{\EXCEPT} {\bang}[a]\.{=}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}}\@s{132.76}}%
\@y{%
 [\ensuremath{value \.{\mapsto} m.val}, \ensuremath{version
 \.{\mapsto}(@.version\.{+}1)}]]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 185\hspace{1em}}\@s{120.46}
 \.{\land}\@s{1.18} Send ( [ type \.{\mapsto}\@w{Ack} ,\, bal \.{\mapsto} m .
 bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 186\hspace{1em}}\@s{158.64} val \.{\mapsto}
 m . val ,\, acc \.{\mapsto} a ] )}%
\@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}}\@s{49.74}}%
\@y{%
 \ensuremath{\.{\land}{\UNCHANGED} {\langle}maxAccBal,\, maxAccVal,\,
 balValue{\rangle}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 188\hspace{1em}}\@s{49.74}}%
\@y{%
 \ensuremath{\.{\land}{\UNCHANGED} {\langle}maxAccBal,\, maxAccVal,\,
 dataResult,\, balValue{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}}\@s{49.74} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxAccBal ,\, maxAccVal ,\, dataResult ,\,
 balValue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, ev ,\, sv \.{\in} Value ,\, b \.{\in} Ballot \.{:} CAS ( ev ,\, sv ,\,
 b )}%
 \@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}}\@s{39.83} \.{\lor} \E\,
 b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Propose ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}}\@s{112.86} \.{\lor} Result
 ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}\@s{112.86} \.{\lor} Commit
 ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 195\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} \.{\lor} Promise ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}}\@s{124.24} \.{\lor} Accept
 ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{124.24} \.{\lor} Ack ( a
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}\@s{124.24} \.{\lor} Read (
 a )}%
\@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}}\@s{124.24}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor} Repair(a)
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}} Spec\@s{1.46} \.{\defeq}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 03 17:37:19 \ensuremath{CST} 2022 by \ensuremath{LENOVO
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Dec} 08
 10:19:29 \ensuremath{CST} 2021 by \ensuremath{LENOVO
}%
\end{cpar}%
\end{lcom}%
\end{document}
